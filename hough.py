...
gray = cv2.cvtColor(img,cv2.COLOR_BGR2GRAY) # grayscale method from cv2
edges = cv2.Canny(gray,50,150,apertureSize = 3) # lazy canny method from cv2; doesn't seem as good as canny_edge_detector.py
...
cv2.imwrite('Other/acnh_hough1.jpg',img_copy1)
...
cv2.imwrite('Other/acnh_hough2.jpg',img_copy2)